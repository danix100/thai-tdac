...
const Apply = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      } = await supabase.from('travelers').insert(travelersData);
      if (travelersError) {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="py-8 font-quicksand">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid lg:grid-cols-5 gap-6">
            ...
            {currentStep <= 3 && <div className="hidden lg:block lg:col-span-1">
    ...
    <div className="relative">
                    {steps.map((step, index) => <div key={step.number} className="relative flex items-center mb-8 last:mb-0">
                        {/* Connecting Line */}
                        {index < steps.length - 1 && <div className="absolute left-6 top-12 w-0.5 h-16 bg-gray-200"></div>}
                        
                        {/* Step Circle */}
                        <div className={cn("w-12 h-12 rounded-full flex items-center justify-center text-lg font-bold z-10 mr-4 flex-shrink-0", step.active ? "bg-primary text-white" : currentStep > step.number ? "bg-green-500 text-white" : "bg-gray-200 text-gray-600")}>
                          {currentStep > step.number ? "✓" : step.number}
                        </div>
                        
                        {/* Step Title */}
                        <span className={cn("text-lg font-medium", step.active ? "text-primary" : currentStep > step.number ? "text-green-700" : "text-gray-600")}>
                          {step.title}
                        </span>
                      </div>)}
                  </div>
            ...
            {currentStep <= 3 && <div className="hidden md:block lg:hidden col-span-full mb-6 sticky top-0 z-10 bg-background">
              <div className="flex justify-between items-center bg-white rounded-lg shadow-sm p-6">
                  {steps.map((step, index) => <div key={step.number} className="flex items-center">
                      <div className="flex items-center">
                        <div className={cn("w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold", step.active ? "bg-primary text-white" : currentStep > step.number ? "bg-green-500 text-white" : "bg-gray-200 text-gray-600")}>
                          {currentStep > step.number ? "✓" : step.number}
                        </div>
            ...
            {/* Main Form Content */}
            <div className={cn(currentStep <= 3 ? "lg:col-span-4" : "lg:col-span-5")}>
              <div className="bg-white rounded-lg shadow-soft p-6 md:p-8">
                ...
                {currentStep === 1 && <Form {...form}>
                    <div className="space-y-8">
                      ...
                      {fields.map((field, index) => <div key={field.id} className="border border-gray-200 rounded-lg p-6 space-y-6">
                          ...
                          {/* Arrival Date */}
                          <FormField control={form.control} name={`travelers.${index}.arrivalDate`} render={({
                      field
                                ...
                                <FormControl>
                                  <DateInput date={field.value} onDateChange={field.onChange} placeholder="Pick arrival date" minDate={new Date()} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>} />

                          {/* Passport Number */}
                          <FormField control={form.control} name={`travelers.${index}.passport`} render={({
                      field
                    }) => <FormItem className="space-y-3">
                                <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                          ...
                          <div className="grid md:grid-cols-2 gap-4">
                            <FormField control={form.control} name={`travelers.${index}.firstName`} render={({
                        field
                      }) => <FormItem className="space-y-3">
                                  <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                                  ...
                                  <FormControl>
                                    <Input placeholder="First name" {...field} className="h-12 border-2 border-gray-200 hover:border-primary focus:border-primary" />
                                  </FormControl>
                                  <FormMessage />
                                </FormItem>} />
                            <FormField control={form.control} name={`travelers.${index}.lastName`} render={({
                        field
                      }) => <FormItem className="space-y-3">
                                  <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                                  ...
                                  <FormControl>
                                    <Input placeholder="Last name" {...field} className="h-12 border-2 border-gray-200 hover:border-primary focus:border-primary" />
                                  </FormControl>
                                  <FormMessage />
                                </FormItem>} />
                          </div>
                          ...
                          {/* Birth Date */}
                          <FormField control={form.control} name={`travelers.${index}.birthDate`} render={({
                      field
                    }) => <FormItem className="space-y-3">
                                <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                                ...
                                <FormControl>
                                  <DateInput date={field.value} onDateChange={field.onChange} placeholder="Pick birth date" maxDate={new Date()} minDate={new Date("1900-01-01")} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>} />
                          ...
                          <div className="grid md:grid-cols-2 gap-4">
                            <FormField control={form.control} name={`travelers.${index}.nationality`} render={({
                        field
                      }) => <FormItem className="space-y-3">
                                  <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                            ...
                            <FormField control={form.control} name={`travelers.${index}.countryOfResidence`} render={({
                        field
                      }) => <FormItem className="space-y-3">
                                  <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                          ...
                          {/* Email */}
                          <div className="grid md:grid-cols-2 gap-4">
                            <FormField control={form.control} name={`travelers.${index}.email`} render={({
                        field
                      }) => <FormItem className="space-y-3">
                                  <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                                  ...
                                  <FormControl>
                                    <Input placeholder="Email address" type="email" {...field} className="h-12 border-2 border-gray-200 hover:border-primary focus:border-primary" />
                                  </FormControl>
                                  <FormMessage />
                                </FormItem>} />
                            <FormField control={form.control} name={`travelers.${index}.confirmEmail`} render={({
                        field
                      }) => <FormItem className="space-y-3">
                                  <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                                  ...
                                  <FormControl>
                                    <Input placeholder="Confirm email address" type="email" {...field} className="h-12 border-2 border-gray-200 hover:border-primary focus:border-primary" />
                                  </FormControl>
                                  <FormMessage />
                                </FormItem>} />
                          </div>
                          ...
                          <div className="grid md:grid-cols-3 gap-4">
                            <FormField control={form.control} name={`travelers.${index}.phoneCode`} render={({
                        field
                      }) => <FormItem className="space-y-3">
                                  <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                                  ...
                                  <Select onValueChange={field.onChange} value={field.value}>
                                    ...
                                    <SelectContent className="max-h-64">
                                      {phoneCodes.map(phone => <SelectItem key={phone.code} value={phone.code}>
                            ...
                            <FormField control={form.control} name={`travelers.${index}.phone`} render={({
                        field
                                  ...
                                  <FormControl>
                                    <Input placeholder="Phone number" {...field} className="h-12 border-2 border-gray-200 hover:border-primary focus:border-primary" />
                                  </FormControl>
                                  <FormMessage />
                                </FormItem>} />
                          </div>
                          ...
                          {/* Gender */}
                          <FormField control={form.control} name={`travelers.${index}.gender`} render={({
                      field
                    }) => <FormItem className="space-y-3">
                                <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                      ...
                      {/* Add Traveler Button */}
                      {fields.length < 4 && <div className="flex flex-col items-center gap-2 p-6 border-2 border-dashed border-primary/30 rounded-lg bg-primary/5 hover:bg-primary/10 transition-all">
                ...
                {currentStep === 2 && <Form {...form}>
                    <div className="space-y-8">
                      ...
                      {/* Departure Country */}
                      <FormField control={form.control} name="departureCountry" render={({
                    field
                  }) => <FormItem className="space-y-3">
                            <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                      ...
                      {/* Purpose of Visit */}
                      <FormField control={form.control} name="purposeOfVisit" render={({
                    field
                  }) => <FormItem className="space-y-3">
                            <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                      ...
                      {/* Flight Number */}
                      <FormField control={form.control} name="flightNumber" render={({
                    field
                  }) => <FormItem className="space-y-3">
                            <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                            ...
                            <FormControl>
                              <Input placeholder="e.g., TG123" {...field} className="h-12 border-2 border-gray-200 hover:border-primary focus:border-primary" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>} />

                      {/* Accommodation */}
                      <FormField control={form.control} name="accommodationType" render={({
                    field
                  }) => <FormItem className="space-y-3">
                            <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                      ...
                      <FormField control={form.control} name="accommodationDetails" render={({
                    field
                  }) => <FormItem className="space-y-3">
                            <FormLabel className="text-base md:text-lg font-bold text-slate-800">
                            ...
                            <FormControl>
                              <Input placeholder="Hotel name, address, or other details" {...field} className="h-12 border-2 border-gray-200 hover:border-primary focus:border-primary" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>} />
                ...
                {currentStep === 3 && <Form {...form}>
                    <div className="space-y-8">
                      ...
                      {/* Processing Options */}
                      <FormField control={form.control} name="processingOption" render={({
                    field
                      ...
                      <div className="flex justify-between">
                        ...
                        <Button type="button" onClick={() => navigate("/confirm-payment")} className="px-8 bg-red-600 hover:bg-red-700 text-white">
                          Continue to Payment
                        </Button>
                      </div>
                    </div>
