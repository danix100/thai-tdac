      ...
      <div className="flex flex-col lg:flex-row min-h-[600px] relative">
        ...
        <div className="w-full lg:w-2/5 relative z-10">
          <img
            ...
            className="w-full h-full object-cover object-right lg:relative lg:z-20 lg:translate-x-10 lg:shadow-xl lg:rounded-xl"
          />
        </div>

        {/* Content Section */}
        <div className="w-full lg:w-3/5 flex items-start justify-center p-6 sm:p-8 lg:p-12 bg-white relative z-0">
          <div className="space-y-5 sm:space-y-6 text-center lg:text-left max-w-2xl">
            <div>
              <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-primary mb-3 sm:mb-4 leading-snug">
            ...
            <div className="grid md:grid-cols-2 gap-5 sm:gap-6">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-primary rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-3">
              <Button
                size="lg"
                className="w-full sm:w-auto sm:min-w-[260px] bg-primary hover:bg-primary-dark text-primary-foreground font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto sm:min-w-[200px] border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-lg transition-all duration-300"
              >
                Contact us
              </Button>
            </div>
