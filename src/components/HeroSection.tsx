...
const HeroSection = () => {
  return (
    <div className="font-quicksand">
      ...
      <section
        className="hidden md:block relative bg-cover bg-center flex items-start justify-center lg:justify-end"
        style={{
      ...
      >
        ...
        {/* Content Box */}
        <div className="relative bg-white/85 backdrop-blur-md p-6 md:p-8 lg:p-12 max-w-2xl w-full md:w-4/5 lg:w-3/5 shadow-2xl flex items-start justify-center lg:justify-end">
          <div className="space-y-4 md:space-y-5 lg:space-y-6 text-center lg:text-left w-full">
            {/* Headline */}
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold text-primary mb-2 md:mb-3 lg:mb-4 leading-tight">
                Thailand Digital Arrival Card
              </h1>
              <p className="text-base md:text-lg lg:text-2xl text-gray-800 mb-4 md:mb-5 lg:mb-6 leading-relaxed font-medium">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col md:flex-row gap-3 md:gap-4 pt-2 md:pt-3">
              <Button
                size="lg"
                className="w-full md:w-auto md:min-w-[200px] lg:min-w-[280px] bg-primary hover:bg-primary-dark text-primary-foreground font-bold px-4 md:px-6 lg:px-8 py-2 md:py-3 lg:py-4 shadow-lg hover:shadow-xl transition-all duration-300 text-sm md:text-base"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="w-full md:w-auto md:min-w-[180px] lg:min-w-[220px] border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground font-bold px-4 md:px-6 lg:px-8 py-2 md:py-3 lg:py-4 transition-all duration-300 text-sm md:text-base"
              >
                Contact us
              </Button>
            </div>
