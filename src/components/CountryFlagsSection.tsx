        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-primary mb-8">
              Countries that Need a <span className="text-primary-light">Thai Visa on Arrival</span>
            </h2>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-primary mb-4">
            Countries Requiring a <span className="text-primary-light">Thai Visa on Arrival</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Travelers from these countries must complete an online application before entering Thailand.
          </p>
        </div>
